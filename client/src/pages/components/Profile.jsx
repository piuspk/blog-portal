...
export const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formData).length === 0) {
      setUpdateUserError("No changes occured!");
      return;
    }
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        >
          ...
          <img
            src={imageFileUrl || currentUser.PictureUrl}
            alt="user"
            className={`rounded-full w-full h-full object-cover border-4 border-[#d280ca] hover:scale-105 transition-transform duration-300 ${
              imageFileUploadProgress &&
              imageFileUploadProgress < 100 &&
              "opacity-60"
            }`}
        ...
        {imageFileUploadError && (
          <Alert className="h-12 justify-center" color="failure">
            {imageFileUploadError}
          </Alert>
        )}
